...
assert.match(source, /button\.dataset\.settingsSection === "providers"\) continue;[\s\S]*button\.addEventListener\("click", resetTransientForm\)/, "leaving Providers must reset the transient add/edit form");
